...
extern class ObjectLoader
{
	...
	function parse(json:Dynamic, onLoad:Object3D->Void) : T;
	...
	function parseImages(json:Dynamic, onLoad:Void) : Array<Dynamic>;
	function parseTextures(json:Dynamic, images:Dynamic) : Array<Texture>;
	function parseObject(data:Dynamic, geometries:Array<Dynamic>, materials:Array<Material>) : T;
}