 ...
 */
@:jsRequire("three", "BufferGeometry")
...
extern class BufferGeometry<Attributes:NormalOrGLBufferAttributes = NormalBufferAttributes> extends EventDispatcher<{ dispose: {} }>
{
	 ...
	 */
	function setIndex(index:haxe.extern.EitherType<BufferAttribute, Array<Float>>) : BufferGeometry;
	/**
	 ...
	 */
	function applyQuaternion(quaternion:Quaternion) : BufferGeometry;
	/**
	 ...
	 */
	function lookAt(vector:Vector3) : BufferGeometry;
	/**
	 ...
	 */
	function setFromPoints(points:haxe.extern.EitherType<Array<Vector3>, Array<Vector2>>) : BufferGeometry;
	/**
