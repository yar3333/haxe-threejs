...
Main.main = function() {
	...
	scene.add(mesh);
	var mesh1 = new THREE.Mesh(new THREE.SphereGeometry(200,20,20),new THREE.MeshBasicMaterial({ map : textureLoader.load("land_ocean_ice_cloud_2048.jpg"), overdraw : 0.2}));
	scene.add(mesh1);
